...
await page.screenshot({ path: '/tmp/fable5-newtiles.png' });
// open a modal to check the new media + title bar
...
if (t) {
  ...
  await page.screenshot({ path: '/tmp/fable5-newtiles-modal.png' });
